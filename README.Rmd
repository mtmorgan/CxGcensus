...
adopted is to download all the data to a local [duckdb][]
database. Download can be time-consuming, but the results are
'memoised' so subsequent calls are more-or-less instantaneous.
